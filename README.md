...
See [plt-config](https://github.com/DEFRA/plt-config) for the manifest shape and the AIE/01 example (Microsoft Graph `email`, `offline_access`, `openid`, `profile`, `User.Read`).
